...
public class Fir  extends Thread{
    ...
    public Fir(Lock l1, Lock l2, int sleep, int activity_max1, int activity_min1, int activity_max2, int activity_min2 )
    {
    ...
    public void run(){
        ...
        int k1 = (int) Math.round(Math.random() * (activity_max2
